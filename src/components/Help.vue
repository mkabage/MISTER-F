      ...
      <div class="col-lg-4">
        ...
        >
          <a
            ...
            aria-selected="true"
          >
            <i class="mdi mdi-help-circle" /> Frequently Asked Questions
          </a>
          <a
            href="#tab2"
            class="nav-link"
            ...
            aria-selected="false"
          >
            <i class="mdi mdi-account" /> Profile
          </a>
          <a
            href="#tab3"
            class="nav-link"
            ...
            aria-selected="false"
          >
            <i class="mdi mdi-account-settings" /> Account
          </a>
          <a
            href="#tab4"
            class="nav-link"
            ...
            aria-selected="false"
          >
            <i class="mdi mdi-heart" /> Favorites
          </a>
          <a
            href="#tab5"
            class="nav-link"
            ...
            aria-selected="false"
          >
            <i class="mdi mdi-coin" /> Transactions
          </a>
          <a
            href="#tab6"
            class="nav-link"
            ...
            aria-selected="false"
          >
            <i class="mdi mdi-help" /> General help
          </a>
        </div>
      </div>
      <div class="col-lg-8">
          ...
          >
            ...
            >
              ...
              <div class="card">
                ...
                >
                  <h5>
                    <button
                      ...
                      type="button"
                      data-toggle="collapse"
                      data-target="#accordion-tab-6-content-2"
                      aria-expanded="false"
                      aria-controls="accordion-tab-6-content-2"
                    >
                ...
                <div
                  id="accordion-tab-6-content-2"
                  class="collapse"
                  aria-labelledby="accordion-tab-6-heading-2"
                  data-parent="#accordion-tab-6"
                >
                  <div class="card-body">
              ...
              <div class="card">
                ...
                >
                  <h5>
                    <button
                      ...
                      type="button"
                      data-toggle="collapse"
                      data-target="#accordion-tab-6-content-3"
                      aria-expanded="false"
                      aria-controls="accordion-tab-6-content-3"
                    >
                ...
                <div
                  id="accordion-tab-6-content-3"
                  class="collapse"
                  aria-labelledby="accordion-tab-6-heading-3"
                  data-parent="#accordion-tab-6"
                >
                  <div class="card-body">
              ...
              <div class="card">
                ...
                >
                  <h5>
                    <button
                      ...
                      type="button"
                      data-toggle="collapse"
                      data-target="#accordion-tab-6-content-4"
                      aria-expanded="false"
                      aria-controls="accordion-tab-6-content-4"
                    >
                ...
                <div
                  id="accordion-tab-6-content-4"
                  class="collapse"
                  aria-labelledby="accordion-tab-6-heading-4"
                  data-parent="#accordion-tab-6"
                >
                  <div class="card-body">
